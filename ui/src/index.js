...
const options = [
  { value: 'http://antennatv-lh.akamaihd.net/i/live_1@329667/master.m3u8', label: 'ANT1' },
  { value: 'http://freeview.ashttp9.visionip.tv/live/tvnetwork-hellenictv-nrg-hsslive-25f-4x3-SDh/chunklist.m3u8', label: 'ERT2' },
  { value: 'http://alfakanali-lh.akamaihd.net/i/live_1@90368/master.m3u8', label: 'ALPHA' },
  ...
  { value: 'http://mgrouphdlive4-f.akamaihd.net/i/live_1@324569/master.m3u8', label: 'EPSILON' },
  { value: 'http://stream.maktv.gr/i/live_1@332903/master.m3u8', label: 'MAKEDONIA' },
